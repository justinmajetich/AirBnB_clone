#!/usr/bin/python3
"""This script defines the DBStorage engine."""
...
class DBStorage:
    ...
    Attributes:
        __engine (sqlalchemy.Engine): The active SQLAlchemy engine.
        __session (sqlalchemy.Session): The active SQLAlchemy session.
    """
