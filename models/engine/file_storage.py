...
class HBNBCommand(cmd.Cmd):
    ...
    def do_show(self, args):
        """ Method to show an individual object's """
        new = args.partition(" ")
        cname = new[0]
        cid = new[2]
    ...
    def help_show(self):
        """ Help infor for the show command """
    ...
    def verify_attribute(cls, attribute):
        """
        Verify if the attribute is correctly formatted or not
        """
