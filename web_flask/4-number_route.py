#!/usr/bin/python3
"""script that start Flask web app display is number only if n is an integer"""
...
def python_text(text):
    """
    Route handler for the /python/ URL with a default value and/python/textURL
...
def is_number(n):
    ...
    Returns:
        str:string n is a number if n is an integer else a 404 Not Found error
    """
