#!/usr/bin/python3
"""script that starts a Flask web app display a HTML page only if n is an integer"""
...
def number_template(n):
    ...
    Returns:
        str: An HTML page displaying the number in an H1 tag inside the BODY tag.
    """
...
def number_odd_or_even(n):
    ...
    Returns:
        str: An HTML page displaying whether the number is odd or even in an H1 tag inside the BODY tag.
    """
