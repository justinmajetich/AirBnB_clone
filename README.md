...
* Handling names arguments in a function
...
## More Info
![Image representation of the project flow](https://s3.amazonaws.com/intranet-projects-files/concepts/74/hbnb_step2.png)
