...
class test_Place(test_basemodel):
    ...
    def test_description(self):
        ...
        new_user = User(nme="Kasper")
        id_user = new_user.id
        new_place = Place(city_id=id_city, user_id=id_user, name="home", description="a building")
    ...
    def test_number_rooms(self):
        ...
        new_user = User(nme="Kasper")
        id_user = new_user.id
        new_place = Place(city_id=id_city, user_id=id_user, name="home", number_rooms=1)
    ...
    def test_number_bathrooms(self):
        ...
        new_user = User(nme="Kasper")
        id_user = new_user.id
        new_place = Place(city_id=id_city, user_id=id_user, name="home", number_bathrooms=1)
    ...
    def test_max_guest(self):
        ...
        new_user = User(nme="Kasper")
        id_user = new_user.id
        new_place = Place(city_id=id_city, user_id=id_user, name="home", max_guest=2)
    ...
    def test_price_by_night(self):
        ...
        new_user = User(nme="Kasper")
        id_user = new_user.id
        new_place = Place(city_id=id_city, user_id=id_user, name="home", price_by_night=60)
    ...
    def test_latitude(self):
        ...
        new_user = User(nme="Kasper")
        id_user = new_user.id
        new_place = Place(city_id=id_city, user_id=id_user, name="home", latitude=4.13)
    ...
    def test_longitude(self):
        ...
        new_user = User(nme="Kasper")
        id_user = new_user.id
        new_place = Place(city_id=id_city, user_id=id_user, name="home", longitude=4.13)
