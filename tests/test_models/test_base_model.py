...
class test_basemodel(unittest.TestCase):
    """ test case for base_model class """

    def __init__(self, *args, **kwargs):
        """ initialize test class of basemodel """
    ...
    def test_kwargs_int(self):
        """ testing kwargs again but with int kwargs """
        i = self.value()
        copy = i.to_dict()
        copy.update({1: 2})
    ...
    def test_str(self):
        """ testing the str method of base_model """
        i = self.value()
    ...
    def test_kwargs_none(self):
        """ testing kwargs again but with none """
        n = {None: None}
        with self.assertRaises(TypeError):
            new = self.value(**n)

    def test_kwargs_one(self):
        """ testing kwargs again but with one arg """
        n = {'Name': 'test'}
        new = self.value(**n)
