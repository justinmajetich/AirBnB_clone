#!/usr/bin/python3
"""Conatins unittests for the console (command interpreter)."""
import json
import MySQLdb
import os
import sqlalchemy
...
class TestHBNBCommand(unittest.TestCase):
    ...
    def test_fs_create(self):
        """Tests the 'create' command with the file storage option'
        """
    ...
    def test_db_create(self):
        """Tests the create command with the sql storage option
        """
        with patch('sys.stdout', new=StringIO()) as cout:
            cons = HBNBCommand()
    ...
    def test_db_show(self):
        """Tests show command with sql storage.
        """
        with patch('sys.stdout', new=StringIO()) as cout:
            cons = HBNBCommand()
    ...
    def test_db_count(self):
        """Tests count command with the sql storage option
        """
        with patch('sys.stdout', new=StringIO()) as cout:
            cons = HBNBCommand()
            dbc = MySQLdb.connect(
