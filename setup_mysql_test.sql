...
GRANT ALL PRIVILEGES ON hbnb_test_db.* TO 'hbnb_dev'@'localhost'; -- grant all privileges
GRANT SELECT ON performance_schema.* TO 'hbnb_test'@'localhost'; -- grant SELECTprivileges
