...
CREATE USER IF NOT EXISTS 'hbnb_dev'@'localhost' IDENTIFIED BY 'hbnb_dev_pwd'; -- craete user
GRANT ALL ON hbnb_dev_db.* TO 'hbnb_dev'@'localhost'; -- grant all privileges
GRANT SELECT ON performance_schema.* TO 'hbnb_dev'@'localhost'; -- grant SELECTprivileges
